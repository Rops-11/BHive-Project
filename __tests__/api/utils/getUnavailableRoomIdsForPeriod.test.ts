...
describe("getUnavailableRoomIdsForPeriod", () => {
  ...
  beforeAll(async () => {
    ...
    await prisma.room.createMany({
      data: [
        { id: roomId1, roomType: "Standard", roomNumber: "201", isAvailable: true, maxGuests: 2, roomRate: 100, amenities: [] },
        { id: roomId2, roomType: "Deluxe", roomNumber: "202", isAvailable: true, maxGuests: 2, roomRate: 200, amenities: [] },
      ],
    });
